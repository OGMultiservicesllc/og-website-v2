...
def ocase_list():
    ...
    return render_template("admin/client_cases_list.html", rows=rows, q=q, status=status, ctype=ctype, statuses=CASE_STATUSES, types=CASE_TYPES, customers=customers)
